      ...
      <div className="p-2 sm:p-6 rounded-3xl border-[#6c757d33] border-[.5px] shadow-md w-full sm:w-[490px] md:w-[500px] bg-primaryBg">
        ...
        <div className="flex flex-col gap-1.5 sm:gap-3">
          <div className="text-white flex">
            ...
            <div className="flex flex-col">
              <p className="text-white font-semibold focus:outline-none text-[12px] sm:text-base text-left">
                {fromToken.name}
              </p>
              <h1 className="sm:text-sm text-[10px] font-medium text-two text-balanceText text-start">
                {inputVal}
              </h1>
            </div>
          </div>

          <FaArrowDown className="text-notConnectedText items-center ml-1 sm:ml-2.5 text-base mb-1 sm:mb-0 sm:text-2xl" />
        ...
        <div className="text-white my-2 sm:my-6 flex flex-col  gap-1">
          <div className="flex justify-between">
            <p className="sm:text-[16px] text-[9px] font-normal text-two text-start">
              Minimum received
            </p>
            <p className="sm:text-[16px] text-[9px] font-normal text-two text-right items-center">
          ...
          <div className="flex justify-between gap-2">
            ...
            <p className="sm:text-[16px] text-[9px] font-normal text-two text-right flex items-center">
              1 {fromToken.name}{" "}
              <BsArrowRight className="items-center font-thin mx-1  sm:text-xl" />
